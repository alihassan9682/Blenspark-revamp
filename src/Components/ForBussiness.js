      ...
      <section className="section-2 md:grid grid-cols-2 xl:grid-cols-4 xl:mx-20">
        <article className="p-8">
          <div>
            ...
            <p>
              ...
              13-inch screen. Discover the newest Surface for Business devices
              now available. Available with Windows 11.
            </p>
            <button className="block relative cursor-pointer text-blue-600 font-semibold hover:underline transition-transform border-b-blue-500">
              ...
              <span className=" h-4 w-0 right-0 top-1 pl-0 absolute">
                <FaChevronRight />
              </span>
            </button>
          </div>
        ...
        <article className="p-8">
          <div>
            ...
            <p className="inline-block px-3 mt-4 text-black mb-3"></p>
            <h3 className="font-semibold text-xl mt-2 mb-1">
