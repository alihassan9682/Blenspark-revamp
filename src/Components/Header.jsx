  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 lg:ml-16 bg-transparent text-white p-4 sm:px-8 md:px-16 lg:px-24 xl:px-28">
        ...
        <div
          className={`fixed top-0 left-0 h-full w-2/3 bg-gray-700 text-white p-4 sm:hidden z-50 transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"
            }`}
        >
