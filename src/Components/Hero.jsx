...
const Hero = () => {
  ...
  const setCurrentHero = (hero) => {
    navigate(`/${hero.toLowerCase()}`); // Use navigate to navigate to the specified path
  };
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full p-8 sm:p-16 md:p-24 lg:p-32 text-center">
          <div className="logo flex flex-col items-center text-center mb-4 animate-float tracking-tighter">
            <div className="flex flex-row justify-center items-baseline">
              <p className="text-cyan-600 text-6xl sm:text-7xl md:text-8xl lg:text-9xl">
                Blen
              </p>
              <p className="text-gray-700 text-6xl sm:text-7xl md:text-8xl lg:text-9xl">
                Spark
              </p>
            </div>
          ...
          <div className="flex sm:flex-row justify-center gap-4 mt-8 sm:mt-12 md:mt-16 lg:mt-20">
            <button
              onClick={() => setCurrentHero("tech")} // Wrapped in an arrow function
